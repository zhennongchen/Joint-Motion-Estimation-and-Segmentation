...
def get_args_parser():
    ...
    # parser.add_argument('--pretrained_model', default = os.path.join(defaults.sam_dir, 'models', 'unet3D_alldata', 'models', 'model-293.pth'), help='path where to save, empty for no saving')
