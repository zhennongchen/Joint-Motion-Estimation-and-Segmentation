...
import Joint_motion_seg_estimate_CMR.data.data.dataset_2D as dataset_2D
...
def build_data_CMR_2D(args,dataset_name, train_batch_list, train_index_list, full_or_nonzero_slice, shuffle, augment_list, augment_frequency, return_arrays_or_dictionary = 'dictionary'):
    ...
    dataset_train = dataset_2D.Dataset_CMR_2D(patient_list_file,
